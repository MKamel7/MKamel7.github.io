...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: {
      en: 'Virtual commissioning of a packaging cell with IEC 61131-3 Structured Text on a CODESYS SoftPLC controlling a simulated plant over Modbus TCP. I implemented PackML and ISA-TR88.00.02 PackTags, watchdog-based safe shutdown, encrypted OPC UA supervision and bidirectional traceability for 14 safety requirements. The control software is covered by 299 tests with 100% branch coverage.',
      de: 'Virtuelle Inbetriebnahme einer Verpackungszelle mit IEC-61131-3-Structured-Text auf einer CODESYS-SoftPLC, die eine simulierte Anlage über Modbus TCP steuert. Ich implementierte PackML und PackTags nach ISA-TR88.00.02, eine watchdog-basierte sichere Abschaltung, verschlüsselte OPC-UA-Kommunikation sowie bidirektionale Rückverfolgbarkeit für 14 Sicherheitsanforderungen. 299 Tests decken 100 % der Verzweigungen der Steuerungssoftware ab.',
    },
